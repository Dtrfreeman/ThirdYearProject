...
dhParams = [0 -1.5707963267949 0.29 0;0.27 0 0 0;0.0700000000000001 -1.5707963267949 0 0;0 1.5707963267949 0.302 0;0 -1.5707963267949 0 0;0 -1.5707963267949 0.072 0];
thetaOffsets = [0 -1.5707963267949 0 0 0 -1.5707963267949];
lastThreeAxesSign = [1 -1 1];
jointLimits = [-2.87979 2.87979;-1.91986 1.91986;-1.91986 1.22173;-2.79253 2.79253;-2.094395 2.094395;-6.98132 6.98132];
...
eeToJt5 = [1 0 0 0;0 -1 -1.22464679914735e-16 0.072;0 1.22464679914735e-16 -1 -4.40872847693047e-18;0 0 0 1];
    ...
    function validConfig = applyJointLimits(inputConfig, jointLimits, isJointRevolute)
        ...
        for i = 1:numel(inputConfig)
            if jointLimits(i,1) > inputConfig(i) || jointLimits(i,2) < inputConfig(i)
                ...
                if isJointRevolute(i) && (wrappedJointValueOffset < jointRange)
...
hSolns = solveForHCaseZeroA1(R3, a2, a3, alpha2, alpha3, d2, d3, d4);
...
% Helper functions
    ...
    function [hSolns, hasFiniteNumSol] = solveForHCaseZeroA1(R3, a2, a3, alpha2, alpha3, d2, d3, d4)
